...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2024, 8, 16, 3, 56, 32, 168105322, time.UTC),
		},
		"/device-plugin.yaml": &vfsgen۰CompressedFileInfo{
			name:             "device-plugin.yaml",
			modTime:          time.Date(2024, 8, 16, 3, 56, 19, 276357670, time.UTC),
		...
		"/nvidia-device-plugin.yml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 8, 16, 3, 55, 28, 165871128, time.UTC),
		...
		"/nvshare-system-quotas.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 8, 16, 3, 56, 6, 645869219, time.UTC),
		...
		"/nvshare-system.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 8, 16, 3, 55, 51, 732487066, time.UTC),
		...
		"/scheduler.yaml": &vfsgen۰CompressedFileInfo{
			name:             "scheduler.yaml",
			modTime:          time.Date(2024, 8, 16, 3, 56, 35, 226810098, time.UTC),
