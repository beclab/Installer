...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2025, 3, 6, 5, 4, 17, 468126996, time.UTC),
		},
		"/device-plugin.yaml": &vfsgen۰CompressedFileInfo{
			name:             "device-plugin.yaml",
			modTime:          time.Date(2025, 3, 6, 5, 4, 17, 467910036, time.UTC),
		...
		"/nvidia-device-plugin.yml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2025, 3, 6, 5, 4, 17, 467978870, time.UTC),
		...
		"/nvshare-system-quotas.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2025, 3, 6, 5, 4, 17, 468050120, time.UTC),
		...
		"/nvshare-system.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2025, 3, 6, 5, 4, 17, 468101954, time.UTC),
		...
		"/scheduler.yaml": &vfsgen۰CompressedFileInfo{
			name:             "scheduler.yaml",
			modTime:          time.Date(2025, 3, 6, 5, 4, 17, 468189913, time.UTC),
