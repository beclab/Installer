...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2024, 8, 19, 9, 28, 44, 935904460, time.UTC),
		},
		"/device-plugin.yaml": &vfsgen۰CompressedFileInfo{
			name:             "device-plugin.yaml",
			modTime:          time.Date(2024, 8, 19, 9, 28, 44, 935382839, time.UTC),
		...
		"/nvidia-device-plugin.yml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 8, 19, 9, 28, 44, 935626420, time.UTC),
		...
		"/nvshare-system-quotas.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 8, 19, 9, 28, 44, 935732711, time.UTC),
		...
		"/nvshare-system.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2024, 8, 19, 9, 28, 44, 935872126, time.UTC),
		...
		"/scheduler.yaml": &vfsgen۰CompressedFileInfo{
			name:             "scheduler.yaml",
			modTime:          time.Date(2024, 8, 19, 9, 28, 44, 935951334, time.UTC),
