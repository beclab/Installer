...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2025, 4, 16, 13, 39, 26, 613709490, time.UTC),
		},
		"/device-plugin.yaml": &vfsgen۰CompressedFileInfo{
			name:             "device-plugin.yaml",
			modTime:          time.Date(2025, 4, 16, 13, 39, 26, 613507698, time.UTC),
		...
		"/nvidia-device-plugin.yml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2025, 4, 16, 13, 39, 26, 613565115, time.UTC),
		...
		"/nvshare-system-quotas.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2025, 4, 16, 13, 39, 26, 613634407, time.UTC),
		...
		"/nvshare-system.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2025, 4, 16, 13, 39, 26, 613684532, time.UTC),
		...
		"/scheduler.yaml": &vfsgen۰CompressedFileInfo{
			name:             "scheduler.yaml",
			modTime:          time.Date(2025, 4, 16, 13, 39, 26, 613737991, time.UTC),
